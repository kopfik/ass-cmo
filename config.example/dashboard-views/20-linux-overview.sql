...
WITH normalized AS (
    SELECT
        ...
        CASE
            ...
            WHEN i.os_name ILIKE '%proxmox virtual environment%' OR i.os_name ILIKE '%proxmox ve%' OR i.os_name ILIKE '%proxmox backup server%' OR i.os_name ILIKE '%proxmox mail gateway%' OR i.os_name ILIKE '%proxmox datacenter manager%' OR i.kernel_version LIKE '%-pve' THEN 'proxmox'
